          ...
          <div className="max-w-5xl px-6 mx-auto">
            ...
            <div className="aspect-16/10 group relative mx-auto flex max-w-[22rem] items-center justify-between sm:max-w-sm">
              ...
              <div className="bg-linear-to-b from-muted-foreground/15 absolute inset-0 flex aspect-square items-center justify-center rounded-full border-t to-transparent to-25%">
                <IntegrationCard className="absolute left-0 -translate-x-1/6 top-1/4 -translate-y-1/4">
                  <Gemini />
                </IntegrationCard>
                <IntegrationCard className="absolute top-0 -translate-y-1/2">
                  <Replit />
                </IntegrationCard>
                <IntegrationCard className="absolute right-0 translate-x-1/6 top-1/4 -translate-y-1/4">
                  <MagicUI />
                </IntegrationCard>
              </div>
              ...
              {/* Center logo */}
              <div className="absolute inset-x-0 bottom-0 flex justify-center gap-2 mx-auto my-2 w-fit">
                <div className="relative z-20 p-1 border rounded-full bg-muted">
                  <IntegrationCard
                    className="shadow-xl shadow-black-950/10 dark:bg-background size-16 border-black/20 dark:border-white/25 dark:shadow-white/15"
                    isCenter
                  >
                    <Image
                      src="/nuro1.png"
            ...
            {/* Text and button */}
            <div className="relative z-20 max-w-lg mx-auto mt-12 space-y-6 text-center bg-linear-to-t from-background">
